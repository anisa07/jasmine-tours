...
const tourData = [
  {
    description: {
      ...
      text: 'Давайте вместе окунёмся в Амстердам 17-го века, в ту эпоху, когда благородные дамы сжимали талии корсетами и украшали свои прически стильными париками. Именно в это время Ян Вермеер создавал свои великолепные полотна, среди которых и "Девушка с молоком", а Рембрандт вдохновлялся для воплощения романтических образов, таких как, например, Флора. Я с удовольствием расскажу вам о знаменитых героях их произведений и помогу вам стать частью одного из этих потрясающих образов.',
    },
    images: [tour1, tour3],
  },
  {
